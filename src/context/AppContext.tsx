...
const STORAGE_KEY = 'motion-workspace-v3';
  ...
  return [
    {
      ...
      description: 'Creating, editing, reviewing, and launching the Motion tutorial series.',
      color: '#4b5563',
      workspace: 'My Private Workspace',
      targetDate: '2026-10-15',
      milestones: [
        { id: 'm-1', title: 'Script & Concept', deadlineDays: 2, completed: true },
        { id: 'm-2', title: 'Video Recording & Edit', deadlineDays: 7, completed: false },
        { id: 'm-3', title: 'Thumbnails & Publishing', deadlineDays: 14, completed: false },
      ],
...
function getInitialTasks(): TaskItem[] {
  return [
    ...
    },
    {
      ...
      description: 'Cut B-roll footage, balance microphone audio, and export 4k draft.',
      durationMinutes: 30,
      deadline: '2026-10-03',
      priority: 'medium',
      status: 'todo',
      ...
      scheduledEnd: new Date(Date.now() + 86400000 * 2 + 1800000).toISOString(),
      createdAt: Date.now() - 20000000,
    },
    {
      id: 'task-3',
      title: 'Design thumbnails',
      description: 'Render high-contrast Figma mockups for YouTube video title card.',
      durationMinutes: 30,
      deadline: '2026-10-02',
      priority: 'medium',
      status: 'todo',
      projectId: 'proj-yt',
      assignee: 'Motion',
      scheduledStart: new Date(Date.now() + 86400000 * 2 + 3600000).toISOString(),
      scheduledEnd: new Date(Date.now() + 86400000 * 2 + 5400000).toISOString(),
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const createTask = useCallback((taskData: Partial<TaskItem>, autoSchedule = true): TaskItem => {
    ...
    const newTask: TaskItem = {
      ...
      assignee: taskData.assignee || 'Motion',
